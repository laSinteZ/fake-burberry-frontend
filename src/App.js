...
const productImages = [{src: "img/product-1.jpg", alt: "Long Cotton Gabardine Car Coat"}, {src: "img/product-2.jpg", alt: "Long Cotton Gabardine Car Coat"}, {src: "img/product-3.jpg", alt: "Long Cotton Gabardine Car Coat"}, {src: "img/product-4.jpg", alt: "Long Cotton Gabardine Car Coat"}];
...
export default function App() {
  return (
    <IntlProvider locale="ru">
      <div>
        <Helmet>
          <title>{productTitle} | Men - Burberry</title>
          <meta
            name="description"
